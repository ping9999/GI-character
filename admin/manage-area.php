                ...
                <table class="tbl-full">
                    ...
                    <?php 
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo SITEURL; ?>admin/delete-area.php?id=<?php echo $id; ?>&image_name=<?php echo $image_name; ?>" class="btn-danger">Delete area</a>
                                        </td>
                                    </tr>
                        ...
                        else
                        {
                            ...
                            <tr>
                                <td colspan="6"><div class="error">No area Added.</div></td>
                            </tr>
